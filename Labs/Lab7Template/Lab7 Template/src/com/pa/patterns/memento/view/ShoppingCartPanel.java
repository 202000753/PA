...
public class ShoppingCartPanel {
    ...
    public ShoppingCartPanel() {
        ...
        shoppingCartController.addProduct("Chewing Gum", 0.1);
        shoppingCartController.addProduct("Powerbank", 30);
        shoppingCartController.addProduct("PS4", 350);
        ...
        gridPaneCartContents.add(hBoxUndo, 1, 2);
