...
public class UniversityNetworkController {
    ...
    public void doAddPerson() {
        try {
            ...
            if(id == null) {
                view.displayError("You must select the ID.");
                return;
            }

            if(name == null) {
                view.displayError("You must enter the Name.");
                return;
            }

            if(role == null) {
                view.displayError("You must select the Role.");
                return;
            }

            model.addPerson(new Person(Integer.valueOf(id), name, Person.PersonRole.valueOf(role)));
